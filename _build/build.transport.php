...
$sources = array(
    ...
    'source_cmp_assets' => $root.'manager/components/'. PKG_NAME_LOWER,
...
$modx->log(modX::LOG_LEVEL_INFO, 'Adding in resolvers...');
$vehicle->resolve('file', array(
    'source' => $sources['source_cmp_assets'],
